...
use Raystech\MediaManager\Exceptions\InvalidUrlGenerator;
use Raystech\MediaManager\Models\Media;
use Raystech\MediaManager\PathGenerator\PathGeneratorFactory;

class UrlGeneratorFactory
{
  public static function createForMedia(Media $media, string $conversionName = ''): UrlGenerator
  {
    $urlGeneratorClass = config('mediamanager.url_generator')
    ?: 'Raystech\MediaManager\UrlGenerator\\' . ucfirst($media->getDiskDriverName()) . 'UrlGenerator';
