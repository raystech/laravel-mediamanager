...
use Raystech\MediaManager\Exceptions\InvalidConversion;
...
class ConversionCollection extends Collection
{
     ...
     * @return mixed
     *
     * @throws \Raystech\MediaManager\Exceptions\InvalidConversion
     */
    ...
    protected function addConversionsFromRelatedModel(Media $media)
    {
        ...
        /** @var \Raystech\MediaManager\HasMedia\HasMedia $model */
        $model = new $modelName();
