...
use Raystech\MediaManager\Media\MediaModel;
...
class MediaRepository
{
  ...
  /** @param \Raystech\MediaManager\Models\Media $model */
   ...
   *
   * @param \Raystech\MediaManager\Media\MediaModel $model
   ...
   * MediaModel $model
   */
  public function getCollection($model, string $collectionName, $filter = []): Collection
  {
